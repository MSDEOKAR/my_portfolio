  ...
  return (
    <section ref={ref} className="py-32 bg-slate-950 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-5xl font-bold text-white mb-4">Education & Experience</h2>
            ...
            <div className="space-y-12">
              {experiences.map((exp, index) => (
                ...
                >
                  {/* Timeline dot */}
                  <motion.div
                    className="absolute left-8 md:left-1/2 w-4 h-4 bg-blue-600 rounded-full border-4 border-slate-950 z-10 transform -translate-x-1/2"
                    ...
                    >
                      <div className="flex items-start gap-4 mb-4">
                        <div className="w-12 h-12 rounded-lg bg-blue-600/20 flex items-center justify-center flex-shrink-0">
                          <exp.icon className="text-blue-400" size={24} />
                        </div>
